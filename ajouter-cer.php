...
if(isset($_POST['submit'])) {
    ...
    if(in_array($file_extension, $valid_extension)){
      if(move_uploaded_file($img_cover['tmp_name'],$target_file)){
        $statement = $pdo->prepare("INSERT INTO circuit ( `ville-depart`, `ville-arrive`, `trajet`, `date-depart`, `heure-depart`, `dure`, `img`, `carte`, `prix`, `date-res`, `date-creation`) VALUES(?,?,?,?,?,?,?,?,?,?,CURRENT_TIMESTAMP)");
